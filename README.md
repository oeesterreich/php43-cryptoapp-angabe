...
```
cd existing_repo
git remote add origin https://gitlab.com/hak-imst/neun/cryptoapp-angabe-php43.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.com/hak-imst/neun/cryptoapp-angabe-php43/-/settings/integrations)
